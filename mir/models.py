...
class CNN_BiLSTM_Attention(nn.Module):
    def __init__(self, num_layers):
        ...
        self.att = nn.Conv2d(32*6, 20, kernel_size = 1)
        self.bilstm = nn.LSTM(32*6, 20, batch_first = True, bidirectional = True, num_layers = num_layers, dropout = 0.2)
...
class CNN_reduit_BiLSTM_Attention(nn.Module):
    def __init__(self, num_layers):
        super(CNN_reduit_BiLSTM_Attention, self).__init__()
        
        self.conv1 = nn.Conv2d(3, 8, kernel_size = 3)
        self.conv2 = nn.Conv2d(8, 16, kernel_size = 3)
        self.att = nn.Conv2d(16*30, 20, kernel_size = 1)
        self.bilstm = nn.LSTM(16*30, 20, batch_first = True, bidirectional = True, num_layers = num_layers, dropout = 0.2)
